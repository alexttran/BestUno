...
public class TeamJacobAndAlex_UnoPlayer implements UnoPlayer {
        ...
        if (upCard.getRank() != Rank.NUMBER) {
            for (int i = 0; i < hand.size(); i++) {
                if (hand.get(i).canPlayOn(upCard, calledColor)) {
                    if (hand.get(i).getRank() == Rank.DRAW_TWO && hand.get(i).getColor() == color) {
                        numDraw2Color++;
                        arr.set(i, "Draw 2");
                        numPlayable++;
                    } else if (hand.get(i).getRank() == Rank.DRAW_TWO && hand.get(i).getRank() == upCard.getRank()) {
                        numRankDraw2++;
                        arr.set(i, "RankDraw2");
                        numPlayable++;
                    } else if (hand.get(i).getRank() == Rank.REVERSE && hand.get(i).getColor() == color) {
                        numReverseColor++;
                        arr.set(i, "Reverse");
                        numPlayable++;
                    } else if (hand.get(i).getRank() == Rank.REVERSE && hand.get(i).getRank() == upCard.getRank()) {
                        numRankReverse++;
                        ...
                        arr.set(i, "Wild4");
                        numPlayable++;
                    } else if (hand.get(i).getRank() == Rank.SKIP && hand.get(i).getColor() == color) {
                        numSkipColor++;
                        arr.set(i, "Skip");
                        numPlayable++;
                    } else if (hand.get(i).getRank() == Rank.SKIP && hand.get(i).getRank() == upCard.getRank()) {
                        numRankSkip++;
                        arr.set(i, "RankSkip");
                        numPlayable++;
